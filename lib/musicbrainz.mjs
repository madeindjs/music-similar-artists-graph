 ...
 */
export async function findArtist(artist) {
 ...
 */
export async function fetchSimilarArtistsByArtistId(artistId) {
  const params = new URLSearchParams()
 ...
 * @returns {Promise<SimilarArtist[]>}
 */
export async function fetchSimilarArtistsByArtistName(artistName) {
